...
export default function Hero() {
  return (
    <div className="relative flex items-center justify-between w-full h-[calc(100vh-100px)] rounded-b-full">
      ...
      <div className="absolute px-20 inset-0 flex flex-col items-center md:items-start justify-center text-center text-white text-xl sm:text-2xl lg:text-2xl font-semibold gap-10 lg:gap-20">
        {/* Texte principal */}
